...
if __name__ == "__main__":
    ###run 本脚本的例子：
    ## python docx2json.py  -working_dir data  -subject文综  -question_docx 2019年全国II卷文科综合高考真题.docx  -answer_docx 2019年全国II卷文科综合高考真题-答案.docx -img_dir img -http_head https://ehomework.oss-cn-hangzhou.aliyuncs.com/item/  -out_json文综.json
    ...
    debug = True
    if debug:  ###跑例子用的默认参数,保证在ipython下面也可以直接跑
